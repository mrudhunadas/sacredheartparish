...
import { Heart, Calendar, Bell, ArrowRight, Cross, Sparkles, Users, Mail } from 'lucide-react';
...
const Index = () => {
  ...
  const handleAnnouncementClick = (announcementId: number) => {
    ...
    // Navigate to detailed view or expand content
  };
          ...
          <div className="text-center px-8">
            ...
            <form onSubmit={handleNewsletterSubmit} className="max-w-md mx-auto">
              ...
              {subscriptionStatus === 'success' && (
                <p className="mt-3 text-olive-green font-medium">Thank you for subscribing to our newsletter!</p>
              )}
            </form>
          </div>
        </section>
